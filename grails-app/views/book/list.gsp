                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="available" title="${message(code: 'book.available.label', default: 'Available')}" />
                        
                            <g:sortableColumn property="publishingDate" title="${message(code: 'book.publishingDate.label', default: 'Publishing Date')}" />
                    ...
                    <g:each in="${bookInstanceList}" status="i" var="bookInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:formatBoolean boolean="${bookInstance.available}" /></td>
                        
                            <td><g:formatDate date="${bookInstance.publishingDate}" /></td>
